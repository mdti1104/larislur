...
<html lang="en">
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="{{ asset('catalogue/css/cs-style.css')}}">
        ...
        <div id="main">
            ...
            <div class="cs-content-container">
                ...
                <div class="illustration_bg">
                    <div class="bg"  data-bg="{{ asset('catalogue/images/bg/dec/cs-bg.png')}}"></div>
                </div>
            </div>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="ms-item_fs fl-wrap">
                                            <div class="bg" data-bg="{{ asset('catalogue/images/bg/10.jpg')}}"></div>
                                    ...
                                    <div class="swiper-slide ">
                                        <div class="ms-item_fs fl-wrap">
                                            <div class="bg" data-bg="{{ asset('catalogue/images/bg/11.jpg')}}"></div>
                                            <div class="overlay"></div>
                                        </div>
                                    </div>
                                    <!--ms_item end-->
                                    ...
                                    <div class="swiper-slide">
                                        <div class="ms-item_fs fl-wrap">
                                            <div class="bg" data-bg="{{ asset('catalogue/images/bg/17.jpg')}}"></div>
                                            <div class="overlay"></div>
                                        </div>
                                    </div>
                                    <!--ms_item end-->                                                 
