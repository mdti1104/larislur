                ...
                <section class="hidden-section">
                    <div class="container">
                        <form action="/success" method="get">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <h4 class="cart-title">Your cart <span>{{count($cart)}} items</span></h4>
                                    <table class="table table-border checkout-table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="hidden-xs">
                                                    <h5 class="order-money">Rp. {{(number_format($cart['harga'],0,',','.'))}}</h5>
                                                </td>
                                                <td>
                                                    <input type="number" name="cartin1" value="{{$cart['quantity']}}" max="50" min="1"
                                                        class="order-count">
                                                </td>
                                                <td>
                                                    <h5 class="order-money">Rp. {{(number_format($cart['subtotal'],0,',','.'))}}</h5>
                                                </td>
                                                <td class="pr-remove">
                                                    <a href="/cart/delete/{{$cart['id']}}" title="Remove"><i class="fal fa-times"></i></a>
                                                </td>
                                            </tr>
                                         @endforeach
                                        </tbody>
