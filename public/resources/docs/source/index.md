...
[Get Postman Collection](https://digitalmudasolution.id/public/docs/collection.json)
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "https://digitalmudasolution.id/public/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"ratione","ip_address":"id","latitude":"id","longitude":"fuga"}'
...
```bash
curl -X POST \
    "https://digitalmudasolution.id/public/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"voluptates","latitude":"qui","longitude":"consequuntur"}'
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/holidays?location_id=vel&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/holidays"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=saepe&follow_up_type=reprehenderit&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/crm/follow-ups"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"quod","schedule_type":"quia","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","followup_additional_info":"['call duration' => '1 hour']","allow_notification":true}'
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=et&biz_name=non&mobile_num=8&contact_id=ab&order_by=enim&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/crm/leads"
);
...
```bash
curl -X POST \
    "https://digitalmudasolution.id/public/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"consequuntur","mobile_name":"placeat","call_type":"call","start_time":"impedit","end_time":"est","duration":"sed"}]}'
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=ipsum&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":2,"initial_amount":65640350,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":313422.2,"total_card_slips":10,"total_cheques":19,"closing_note":"consequatur","transaction_ids":"1,2,3"}'
...
let body = {
    "location_id": 2,
    "initial_amount": 65640350,
    "created_at": "2020-5-7 15:20:22",
    "closed_at": "2020-5-7 15:20:22",
    "status": "close",
    "closing_amount": 313422.2,
    "total_card_slips": 10,
    "total_cheques": 19,
    "closing_note": "consequatur",
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/contactapi?type=ipsam&name=suscipit&biz_name=quia&mobile_num=10&contact_id=fugit&order_by=accusantium&direction=rerum&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"deleniti","prefix":"quo","first_name":"voluptas","middle_name":"ut","last_name":"unde","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"ab","address_line_2":"voluptatem","city":"in","state":"ut","country":"numquam","zip_code":"beatae","customer_group_id":"illo","contact_id":"doloribus","dob":"2000-06-13","custom_field1":"enim","custom_field2":"fugit","custom_field3":"quia","custom_field4":"optio","email":"dolor","shipping_address":"id","position":"id","opening_balance":0,"source_id":1,"life_stage_id":13,"assigned_to":[]}'
...
let body = {
    "type": "customer",
    "supplier_business_name": "deleniti",
    "prefix": "quo",
    "first_name": "voluptas",
    "middle_name": "ut",
    "last_name": "unde",
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"vel","prefix":"recusandae","first_name":"expedita","middle_name":"vitae","last_name":"nostrum","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"architecto","address_line_2":"culpa","city":"sunt","state":"expedita","country":"similique","zip_code":"rerum","customer_group_id":"neque","contact_id":"est","dob":"2000-06-13","custom_field1":"et","custom_field2":"illo","custom_field3":"est","custom_field4":"voluptatem","email":"dignissimos","shipping_address":"et","position":"eum","opening_balance":10.3,"source_id":10,"life_stage_id":19,"assigned_to":[]}'
...
```bash
curl -X POST \
    "https://digitalmudasolution.id/public/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":18,"card_number":"at","card_holder_name":"quia","card_transaction_number":"et","card_type":"et","card_month":"ut","card_year":"in","card_security":"voluptatem","transaction_no_1":"voluptas","transaction_no_2":"laborum","transaction_no_3":"qui","cheque_number":"nesciunt","bank_account_number":"nobis","note":"explicabo"}'
...
let body = {
    ...
    "transaction_no_2": "laborum",
    "transaction_no_3": "qui",
    "cheque_number": "nesciunt",
    "bank_account_number": "nobis",
    "note": "explicabo"
}
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/expense?location_id=laboriosam&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=aut&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/expense"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":8,"final_total":9338.883,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":5,"expense_for":5,"contact_id":6,"additional_notes":"quia","is_refund":0,"is_recurring":0,"recur_interval":11,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"ut","recur_repetitions":19,"payment":[{"amount":453.13,"method":"cash","account_id":13,"card_number":"sed","card_holder_name":"soluta","card_transaction_number":"aut","card_type":"non","card_month":"debitis","card_year":"quae","card_security":"enim","transaction_no_1":"consectetur","transaction_no_2":"itaque","transaction_no_3":"est","note":"quaerat","cheque_number":"id"}]}'
...
let body = {
    "location_id": 8,
    "final_total": 9338.883,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 5,
    "expense_for": 5,
    "contact_id": 6,
    "additional_notes": "quia",
    "is_refund": 0,
    "is_recurring": 0,
    "recur_interval": 11,
    ...
    "payment": [
        {
            ...
            "card_year": "quae",
            "card_security": "enim",
            "transaction_no_1": "consectetur",
            "transaction_no_2": "itaque",
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "https://digitalmudasolution.id/public/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":5690.4,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":1,"expense_for":16,"contact_id":3,"additional_notes":"modi","is_recurring":0,"recur_interval":16,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"omnis","recur_repetitions":19,"payment":[]}'
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/expense-refund?location_id=qui&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=dolore&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/expense-refund"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/product?brand_id=eum&category_id=corporis&sub_category_id=cupiditate&location_id=repellendus&selling_price_group=delectus&name=molestias&sku=sapiente&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/product"
);

let params = {
    "brand_id": "eum",
    "category_id": "corporis",
    "sub_category_id": "cupiditate",
    "location_id": "repellendus",
    "selling_price_group": "delectus",
    "name": "molestias",
    "sku": "sapiente",
    "per_page": "10",
};
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/product/1?selling_price_group=excepturi" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/product/1"
);

let params = {
    "selling_price_group": "excepturi",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/variation/?brand_id=sit&category_id=quo&sub_category_id=aliquid&not_for_selling=ut&name=molestiae&sku=non&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/variation/"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/sell?location_id=sint&contact_id=neque&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&user_id=saepe&service_staff_id=eaque&shipping_status=ordered&only_subscriptions=possimus&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/sell"
);
...
let params = {
    ...
    "end_date": "2018-06-25",
    "user_id": "saepe",
    "service_staff_id": "eaque",
    "shipping_status": "ordered",
    "only_subscriptions": "possimus",
    "order_by_date": "desc",
    "per_page": "10",
};
Object.keys(params)
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":17,"contact_id":1,"transaction_date":"2020-07-22 15:48:29","invoice_no":"vel","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":12,"discount_amount":10,"discount_type":"fixed","sale_note":"omnis","staff_note":"laborum","commission_agent":11,"shipping_details":"Express Delivery","shipping_address":"alias","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":14,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":5,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"est","recur_repetitions":9,"rp_redeemed":19,"rp_redeemed_amount":13.5,"types_of_service_id":19,"service_custom_field_1":"eum","service_custom_field_2":"occaecati","service_custom_field_3":"dicta","service_custom_field_4":"qui","round_off_amount":203914557.7414,"table_id":7,"service_staff_id":12,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":12,"note":"soluta"}],"payments":[{"amount":453.13,"method":"cash","account_id":5,"card_number":"ex","card_holder_name":"et","card_transaction_number":"quas","card_type":"sint","card_month":"sint","card_year":"totam","card_security":"omnis","transaction_no_1":"omnis","transaction_no_2":"laudantium","transaction_no_3":"dolore","bank_account_number":"quia","note":"explicabo","cheque_number":"at"}]}]}'
    ...
    "sells": [
        {
            ...
            "service_custom_field_1": "eum",
            "service_custom_field_2": "occaecati",
            "service_custom_field_3": "dicta",
            "service_custom_field_4": "qui",
            "round_off_amount": 203914557.7414,
            "table_id": 7,
            "service_staff_id": 12,
            "change_return": 0,
            "products": [
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/sell/55" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/sell/55"
);
...
```bash
curl -X PUT \
    "https://digitalmudasolution.id/public/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":5,"discount_amount":10,"discount_type":"fixed","sale_note":"qui","staff_note":"et","sells":[{"is_suspend":false}],"commission_agent":12,"shipping_details":"Express Delivery","shipping_address":"pariatur","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":3,"pay_term_number":16,"pay_term_type":"months","is_recurring":0,"recur_interval":6,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"nesciunt","recur_repetitions":1,"rp_redeemed":5,"rp_redeemed_amount":13.5,"types_of_service_id":19,"service_custom_field_1":"ipsum","service_custom_field_2":"molestias","service_custom_field_3":"natus","service_custom_field_4":"corporis","round_off_amount":25.78954,"table_id":18,"service_staff_id":10,"change_return":0,"change_return_id":7,"products":[{"sell_line_id":14,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":3,"discount_amount":0,"discount_type":"percentage","sub_unit_id":10,"note":"consequatur"}],"payments":[{"payment_id":1,"amount":453.13,"method":"cash","account_id":19,"card_number":"accusamus","card_holder_name":"odit","card_transaction_number":"maxime","card_type":"perferendis","card_month":"rerum","card_year":"libero","card_security":"et","transaction_no_1":"maiores","transaction_no_2":"eos","transaction_no_3":"perferendis","note":"explicabo","cheque_number":"minus","bank_account_number":"id"}]}'
...
let body = {
    ...
    "subscription_no": "nesciunt",
    "recur_repetitions": 1,
    "rp_redeemed": 5,
    "rp_redeemed_amount": 13.5,
    "types_of_service_id": 19,
    "service_custom_field_1": "ipsum",
    "service_custom_field_2": "molestias",
    "service_custom_field_3": "natus",
    "service_custom_field_4": "corporis",
    "round_off_amount": 25.78954,
    "table_id": 18,
    "service_staff_id": 10,
    "change_return": 0,
    "change_return_id": 7,
    ...
    "payments": [
        {
            ...
            "card_transaction_number": "maxime",
...
```bash
curl -X DELETE \
    "https://digitalmudasolution.id/public/connector/api/sell/sed" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "https://digitalmudasolution.id/public/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":5,"transaction_date":"2020-5-7 15:20:22","invoice_no":"ut","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":9,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "https://digitalmudasolution.id/public/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":5,"shipping_status":"ordered","delivered_to":"vel"}'
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/table?location_id=tempore" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/table"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/taxonomy?type=enim" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/user/loggedin"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/user?service_staff=distinctio" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/user"
);

let params = {
    "service_staff": "distinctio",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/user/1"
);
...
```bash
curl -X POST \
    "https://digitalmudasolution.id/public/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"qui","new_password":"optio"}'
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/profit-loss-report?location_id=asperiores&start_date=2018-06-25&end_date=2018-06-25&user_id=occaecati" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/profit-loss-report"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "https://digitalmudasolution.id/public/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://digitalmudasolution.id/public/connector/api/notifications"
);
